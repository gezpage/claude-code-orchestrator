...
Once alignment is complete, write the alignment log to `{{ run_folder }}/alignment-log.md`. The log should capture: all decisions made, the reasoning, and any remaining open items.
