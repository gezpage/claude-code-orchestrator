...
3. Identify ambiguities, risks, and unknowns. Write a findings file at `{{ run_folder }}/findings.md`.
4. Summarise what you found — what is clear, what is unclear, what background exists.
