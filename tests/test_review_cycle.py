...
def test_max_iterations_exactly_2(tmp_path):
    ...
    def counting_stage(stage, impl, variables, run_folder, docs_root, project, log_path):
...
def test_only_failed_reviewers_rerun(tmp_path):
    ...
    def tracking_stage(stage, impl, variables, run_folder, docs_root, project, log_path):
        if stage == "review":
